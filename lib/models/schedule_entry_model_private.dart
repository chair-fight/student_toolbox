...
class ScheduleEntryModelPrivate implements ScheduleEntryModel {
  final int seid;
  final String name;
  final int weekDay;
  ...
  @override
  Model fromJson(Map<String, dynamic> json) => ScheduleEntryModelPrivate(
        seid: json['seid'],
        name: json['name'],
  ...
  @override
  Model placeholder() => ScheduleEntryModelPrivate(
        seid: 0,
